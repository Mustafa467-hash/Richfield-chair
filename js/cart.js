            ...
            cartHoverTable.innerHTML += `
                          <div class = "row">
                            ...
                            <div class = "col-lg-3 si-close">
                                 ...
                                 <div class = "product"><button class = "removeCart"><i class="icon_close"></i></button></div>
                            </div>
                          </div>
                `;
        });
...
function typeInput(){
    ...
    for(let i=0; i < decreaseButtons.length; i++) {
        let currentQuantity = parseInt(decreaseButtons[i].parentElement.querySelector('input').value);
        ...
        else if(currentQuantity <= 0 || isNaN(currentQuantity) === true || currentQuantity == ''){
...
function deleteButtons() {
    ...
    for(let i=0; i < deleteButtons.length; i++) {
        deleteButtons[i].addEventListener('click', () => {
            ...
            localStorage.setItem('totalCost', (cartCost - (cartItems[productId].price * cartItems[productId].inCart)).toString());
            localStorage.setItem('totalCostDiscount', (cartCostDiscount - (cartItems[productId].discount * cartItems[productId].inCart)).toString());

            localStorage.setItem('totalCostClone', (cartCost - (cartItems[productId].price * cartItems[productId].inCart)).toString());
            localStorage.setItem('totalCostDiscountClone', (cartCostDiscount - (cartItems[productId].discount * cartItems[productId].inCart)).toString());
